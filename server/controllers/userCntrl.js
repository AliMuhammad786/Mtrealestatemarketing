...
export const createUser = asyncHandler(async (req, res) => {
  ...
  } else res.status(201).send({ message: "User already register" });
});

// function to book a visit residency
...
//  function to add a favourite list of user
...
// funciton to get all favourites
